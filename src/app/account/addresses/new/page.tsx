...
import { ChevronLeft, MapPin, Save, AlertCircle } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold text-secondary-800">إضافة عنوان جديد</h1>
            </div>
            ...
            <div className="card p-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        >
                            {loading ? <div className="spinner"></div> : <><Save className="w-5 h-5" /> حفظ العنوان</>}
                        </button>
