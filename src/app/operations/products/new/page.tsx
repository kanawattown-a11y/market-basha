...
import { ChevronLeft, Save, Upload, X, AlertCircle, Star } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                                ...
                                {images.map((img, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/70 to-transparent p-2 flex items-center justify-between">
                                            {mainImageIndex !== index && (
                                                <button type="button" onClick={() => setAsMain(index)} className="text-white text-xs hover:text-primary">
                                                    تعيين رئيسية
                                                </button>
                                            )}
                                            <button type="button" onClick={() => removeImage(index)} className="text-red-400 hover:text-red-300 mr-auto">
                                                <X className="w-5 h-5" />
                                            </button>
                                        </div>
                                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    <button type="submit" disabled={loading} className="btn btn-primary w-full sm:w-auto">
                        {loading ? <div className="spinner"></div> : <><Save className="w-5 h-5" /> إضافة المنتج</>}
                    </button>
