...
const menuItems = [
    ...
    { href: '/operations/offers', label: 'عروض المنتجات', icon: Gift },
    { href: '/operations/category-offers', label: 'عروض المتاجر', icon: Tag },
            ...
            <div className="p-4 border-b border-gray-700">
                <Link href="/operations" className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span className="block text-xs text-gray-400">لوحة العمليات</span>
                    </div>
                </Link>
            </div>
            ...
            <div className="p-4 border-b border-gray-700">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-400">موظف عمليات</p>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed top-0 right-0 left-0 z-40 bg-secondary-800 px-4 py-3 flex items-center justify-between">
                ...
                <span className="text-white font-bold">لوحة العمليات</span>
